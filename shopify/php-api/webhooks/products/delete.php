...
$file = "https://dev.eworkbridge.com/php-api/webhooks/products/storeapitesting.myshopify.com.delete.json";
if($file) {
 $file = file_get_contents($file);
$file = json_decode($file, JSON_PRETTY_PRINT);
echo '<ol><li>Product is Deleted : Product title ID:'. $file['id'].'</li><br>';	
}
else { ?>
