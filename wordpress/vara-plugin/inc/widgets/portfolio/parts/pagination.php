 ...
 * Posts Pagination
 */
if (!$settings['portfolio_pagination_visibility'] || $settings['portfolio_layout'] == 'carousel' && function_exists('grada_paging_navigation')) {
	return;
}
 ...
 * Hover Animation
 */
if ($settings['portfolio_style_pagination_hover_animation']) {
	$grada_show_more_button_class[] = 'elementor-animation-' . $settings['portfolio_style_pagination_hover_animation'];
}

/**
 * Alignment
 */
if ($settings['portfolio_style_pagination_alignment'] == 'center') {
	$grada_show_more_button_holder_class[] = 'gs-text-center';
} elseif ($settings['portfolio_style_pagination_alignment'] == 'right') {
	$grada_show_more_button_holder_class[] = 'gs-text-right';
}
?>
<?php
if ($settings['portfolio_pagination_style'] == 'normal') {
