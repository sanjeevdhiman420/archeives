<?php
/**
 * Portfolio > Content Options > Carousel
 */
...
$this->add_responsive_control(
	'portfolio_carousel_custom_height',
	[
		'label' => esc_html__('Custom Height', 'vara-plugin'),
		'type' => \Elementor\Controls_Manager::SLIDER,
		'size_units' => ['vh', 'px', '%'],
		'selectors' => [
			'{{WRAPPER}} .gs-portfolio-list .owl-stage .owl-item .gs-full-height-img' => 'height: {{SIZE}}{{UNIT}};',
		],
		'default' => [
			'unit' => 'vh',
			'size' => '80'
		...
		'condition' => [
			'portfolio_carousel_height' => 'full'
		]
	]
);

$this->add_control(
	'portfolio_carousel_loop',
	[
...
$this->add_control(
	'portfolio_carousel_center',
	[
		'label' => esc_html__('Center', 'vara-plugin'),
		'type' => \Elementor\Controls_Manager::SWITCHER,
		'label_on' => esc_html__('On', 'vara-plugin'),
		'label_off' => esc_html__('Off', 'vara-plugin'),
		'return_value' => 'yes',
...
$this->add_responsive_control(
	'portfolio_carousel_stage_padding',
	[
...
$this->add_control(
	'portfolio_carousel_start_position',
	[
...
$this->add_control(
	'portfolio_carousel_autoplay_timeout',
	[
...
$this->add_control(
	'portfolio_carousel_smart_speed',
	[
