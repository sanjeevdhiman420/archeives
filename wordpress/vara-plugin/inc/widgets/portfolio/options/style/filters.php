...
$this->add_control(
	'portfolio_style_filters_hover_color',
	[
...
$this->add_group_control(
	...
	[
		'name' => 'portfolio_style_filters_typography',
...
$this->add_group_control(
	...
	[
		'name' => 'portfolio_style_filters_shadow',
...
$this->add_responsive_control(
	'portfolio_style_filters_spacing',
	[
...
$this->add_responsive_control(
	'portfolio_style_filters_bottom_spacing',
	[
		'label' => esc_html__('Spacing from Portfolio', 'vara-plugin'),
		'type' => \Elementor\Controls_Manager::SLIDER,
		'size_units' => ['vw', 'px', '%'],
		'selectors' => [
			'{{WRAPPER}} .gs-filters' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		],
	]
);

$this->add_responsive_control(
	'portfolio_style_filters_alignment',
	[
		...
		'default' => 'left',
		'selectors' => [
			'{{WRAPPER}} .gs-filters' => 'text-align: {{VALUE}};',
		],
	]
);