...
$this->add_responsive_control(
	'products_carousel_custom_height',
	[
		'label' => esc_html__('Custom Height', 'vara-plugin'),
		'type' => \Elementor\Controls_Manager::SLIDER,
		'size_units' => ['vh', 'px', '%'],
		'selectors' => [
			'{{WRAPPER}} .gs-woo-product-list .owl-stage .owl-item .gs-full-height-img' => 'height: {{SIZE}}{{UNIT}};',
		],
		'default' => [
			'unit' => 'vh',
			'size' => '80'
		...
		'condition' => [
			'products_carousel_height' => 'full'
		]
	]
);

$this->add_control(
	'products_carousel_loop',
	[
...
$this->add_responsive_control(
	'products_carousel_stage_padding',
	[
...
$this->add_control(
	'products_carousel_start_position',
	[
...
$this->add_control(
	'products_carousel_autoplay_timeout',
	[
