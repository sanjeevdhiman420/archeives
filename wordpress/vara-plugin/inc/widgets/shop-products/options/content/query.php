...
$this->add_control(
	...
	[
		...
		'label_block' => true,
		'options' => $this->grada_return_taxonomies('product_tag'),
		'multiple' => true,
		'conditions' => [
			'terms' => [
				[
					'name' => 'products_auto_query',
					'operator' => '!=',
					'value' => 'yes',
				],
				[
	...
	[
		...
		'fields' => [
			[
				...
				'options' => $this->grada_return_posts('product')
			],
			[
				'name' => 'post_column',
