...
$this->add_group_control(
	...
	[
		'name' => 'products_style_pagination_typography',
...
$this->start_controls_tabs(
	'products_style_pagination_button'
);

$this->start_controls_tab(
	'products_style_pagination_normal_tab',
	[
...
$this->add_control(
	'products_style_pagination_color',
	[
...
$this->add_control(
	'products_style_pagination_background_color',
	[
...
$this->start_controls_tab(
	'products_style_pagination_hover_tab',
	[
...
$this->add_control(
	'products_style_pagination_color_hover',
	[
		'label' => esc_html__('Color', 'vara-plugin'),
		'type' => \Elementor\Controls_Manager::COLOR,
		'selectors' => [
...
$this->add_control(
	'products_style_pagination_background_color_hover',
	[
		'label' => esc_html__('Background Color', 'vara-plugin'),
		'type' => \Elementor\Controls_Manager::COLOR,
		'selectors' => [
...
$this->add_control(
	'products_style_pagination_hover_animation',
	[
		'label' => esc_html__('Hover Animation', 'vara-plugin'),
		'type' => \Elementor\Controls_Manager::HOVER_ANIMATION,
		'condition' => [
			'products_pagination_style' => 'show-more'
		]
	]
);
...
$this->add_control(
	'products_style_pagination_border_type',
	[
...
$this->add_control(
	'products_style_pagination_border_width',
	[
		...
		'conditions' => [
			'terms' => [
				[
					'name' => 'products_style_pagination_border_type',
					'operator' => '!=',
					'value' => 'none',
				],
				[
					'name' => 'products_pagination_style',
					'operator' => '==',
					'value' => 'show-more',
				]
			]
...
$this->add_control(
	'products_style_pagination_border_color',
	[
...
$this->add_control(
	'products_style_pagination_border_radius',
	[
...
$this->add_responsive_control(
	'products_style_pagination_margin',
	[
...
$this->add_responsive_control(
	'products_style_pagination_padding',
	[
...
$this->add_control(
	'products_style_pagination_alignment',
	[
